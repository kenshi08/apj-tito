	 ...
	 <!-- Navigation
        ...
        <header id="top" class="header">
            <div class="text-vertical-center">
                ...
                <h3>Welcome Multi-Cloud Mentoring!</h3>
                 <?PHP
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1 text-center">
                        <h4><strong>Powered by PHP/Bootstrap/Javascript/SDDC/vRA</strong>
                        </h4>
                        VMware APJ!
                        <ul class="list-unstyled">
                            <li><i class="fa fa-envelope-o fa-fw"></i> <a href="mailto:name@example.com">cmbu@vmware.com</a>
                            </li>
                        </ul>
                        <br>
                        <hr class="small">
